...
//	Put all the previous methods in one method but we have to change in the feature all the steps into one step (je remplis le formulaire user system/ see the feature comment)
